...
description: Fetch YouTube video transcripts and generate structured summaries with key insights.
version: 1.0.0
author: abe238
...
Fetch transcripts from YouTube videos and generate structured summaries.
...
`/Users/qsy/Desktop/tennis/scripts/mcp-server-youtube-transcript`

If not present, install it:
```bash
cd /Users/qsy/Desktop/tennis/scripts
...
```bash
cd /Users/qsy/Desktop/tennis/scripts/mcp-server-youtube-transcript && node --input-type=module -e "
...
```
/Users/qsy/Desktop/tennis/data/transcripts/YYYY-MM-DD_VIDEO_ID.txt
```
...
## Tennis-Specific Usage (网球专用)

When summarizing tennis instruction videos (e.g., Feel Tennis, Top Tennis Training):

1.  **Extract technique checkpoints** - Look for specific body positions, angles, timing cues
2.  **Identify drills mentioned** - Note any practice drills with names and descriptions
3.  **Note "feel cues"** - Mental triggers like "sit in the chair", "check your watch"
4.  **Flag common mistakes** - What errors does the video warn against?
5.  **Save to tennis_coach skill** - If insights are valuable, add them to `.agent/skills/tennis_coach/SKILL.md`
