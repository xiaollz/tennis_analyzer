...
### §5.1 Feel Tennis Tomaz 6 drills（视频 `0a7s64RgJOs`，5/9 整合 + 5/10 升级为顶层协议）

> **5/10 升级**：用户原话"必须加入"——这 6 个 drill 已正式进入顶层训练协议 [`hsa_training_drills_master.md`](hsa_training_drills_master.md) §1 阶段 0/1/2 + §0.4 触发协议。**以后用户问"如何防 backswing"，直接拉这些 drill，不再只讲道理**。

| # | Drill | 时间戳 | 顶层协议编号 | 阶段 | 做法 | 目的 |
|---|---|---|---|---|---|---|
| 1 | **侧向"8"字摆动** | [00:40] | **0-E** | 阶段 0 | 双手保持平行（不持拍），身前画大横"8" | 双手协调，单元转动体感 |
| 2 | **挤压球拍** | [01:07] | **0-F** | 阶段 0 | 双手握拍框两侧，向内挤压模拟正手 | 激活肩胛下方肌肉 |
| 3 | **"半对半"正手** | [03:03] | **1-D** ⭐⭐ | 阶段 1 | 准备阶段**完全由左手带拍向后**，挥拍切换给右手 | 强制左手主导 Unit Turn |
| 4 | **合掌推挤转动** | [04:54] | **0-G** ⭐⭐⭐ | 阶段 0 | 双手胸前合十互推，慢速躯干转 | 无球感受上肢张力 |
| 5 | **负重球模拟** | [05:46] | **2-G** ⭐ | 阶段 2 | 非持拍手抓 0.5kg 重力球模拟挥拍 | 重量强制激活左侧 |
| 6 | **WearBands 弹力带** | [07:56] | **2-H** ⭐⭐ | 阶段 2 | 弹力带连非持拍手腕 | 恒定阻力，反馈"塌陷"信号 |

**附加（5/10 整合自 `oPc8OJkG-zw`）**：
| # | Drill | 顶层协议编号 | 阶段 | 做法 | 目的 |
|---|---|---|---|---|---|
| 7 | **Tomaz Weighted Ball（不持拍版）** 🌟 | **0-H** ⭐⭐⭐ | 阶段 0 | **持拍手放松垂在身侧** + 非持拍手抓 1lb 重球扔出去 | "Left active, right passive" 体感终极入口 |
| 8 | **Tomaz Body-Led Drill** | **1-E** ⭐ | 阶段 1 | 助教拉住学员左手，学员侧向转动身体 | 感受身体转动产生的弹性力量（不是手臂拉）|
