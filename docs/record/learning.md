...
| 前挥端：串行模式 | 拍停最低点→手臂独立往前拉 | 🔄 当前主攻 | **球弹地 → 左手拉开 + 蹬转**，身体先动 |
| 触球端：刷 / 扶 / 腕翻 | 向上提拉擦球，打不穿 | ⬇️ 下游结果，**不单独练** | 身体先动自动消失（6/10 晚二 因果链统一） |
...
```mermaid
timeline
    title 正手认知演进 2026-02-27 → 2026-06-10
...
【组间】2-3 分钟：先做 1 个动觉干预，再允许思考/复盘
      干预三选一轮换：① 药球躯干旋转传接 ×15（对接 5/15 药球协议）
                      ② 加重棒水平半圆阴影挥拍（对接 4/18 负重三阶段）
                      ③ 弹力带等长抗阻（躯干稳定对抗，不许扭）
