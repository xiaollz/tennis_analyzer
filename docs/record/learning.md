...
⭐ **关键突破**：
- [6/10 晚 手动放置式 drop 录像根因](#-2026-06-10-晚--录像证据手动放置式-drop不是错过重力是手从没放开过球拍)（line 9266+）— 3 个 clip 一致判定串行模式，扶球是几何必然
...
- swing_97 / swing_566 未获分析（API 524），结论基于 3/5 clip + 速度曲线。
